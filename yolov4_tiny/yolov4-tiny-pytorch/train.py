...
if __name__ == "__main__":
    ...
    #                   序号为0先验框未被使用到，无需过分纠结。
    #---------------------------------------------------------------------#
    anchors_path    = 'F:\\repos\\CSGO_BIG\\code\\yolov4_tiny\\yolov4-tiny-pytorch\\model_data\\yolo_anchors.txt'
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'F:\\repos\\CSGO_BIG\\code\\yolov4_tiny\\yolov4-tiny-pytorch\\model_data\\yolov4_tiny_weights_voc.pth'
    #------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = 'F:\\repos\\CSGO_BIG\\code\\yolov4_tiny\\yolov4-tiny-pytorch\\logs'
    #------------------------------------------------------------------#
    ...
    #------------------------------------------------------#
    train_annotation_path   = 'F:\\repos\\CSGO_BIG\\code\\yolov4_tiny\\yolov4-tiny-pytorch\\VOCdevkit\\VOCcsgo\\csgo_train.txt'
    val_annotation_path     = 'F:\\repos\\CSGO_BIG\\code\\yolov4_tiny\\yolov4-tiny-pytorch\\VOCdevkit\\VOCcsgo\\csgo_valid.txt'
